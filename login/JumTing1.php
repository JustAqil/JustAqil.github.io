...
<body>
<header>
<h1 class="Upper">Buku Tingkatan 1</h1>
...
{
$sql = "INSERT INTO `jumlah_buku2`(`ID`, `Nama`, `Tingkatan`, `Judul_Buku`, `Harga`) values ('$ID','$NamaBuku','$Kelas','$JudulB','$Harga')";
if ($con->query($sql)){
...
<th>Delete</th>
         ...
         <tbody>
<form action="deleteTingg1.php" method="POST">
<?php

$sQuery = "SELECT `ID`, `Nama`, `Tingkatan`, `Judul_Buku`, `Harga` FROM `jumlah_buku2`";
