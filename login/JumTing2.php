...
<body>
<header>
<h1 class="Upper">Buku Tingkatan 2</h1>
...
{
$sql = "INSERT INTO jumlah_bukuting2 (ID,Nama,Tingkatan,Harga) values ('$ID','$NamaBuku','$Kelas','$Harga')";
if ($con->query($sql)){
...
<th>Delete</th>
         ...
         <tbody>
<form action="deleteTingg2.php" method="POST">
<?php

$sQuery = "SELECT `ID`, `Nama`, `Tingkatan`, `Harga` FROM `jumlah_bukuting2`";
