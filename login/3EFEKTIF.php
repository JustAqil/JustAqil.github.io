...
{
$sql = "INSERT INTO 3efektif (ID,Nama,Kelas) values ('$ID','$NamaBuku','$Kelas')";
if ($con->query($sql)){
...
<th>Delete</th>
         ...
         <tbody>
<form action="delete_3E.php" method="POST">
<?php

$sQuery = "SELECT ID,Nama,Kelas from 3efektif";
