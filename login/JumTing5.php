...
<body>
<header>
<h1 class="Upper">Buku Tingkatan 5</h1>
...
{
$sql = "INSERT INTO `jumlah_bukuting5`(`ID`, `Nama`, `Tingkatan`, `Judul_Buku`, `Harga`) values ('$ID','$NamaBuku','$Kelas','$JudulB','$Harga')";
if ($con->query($sql)){
...
<th>Delete</th>
         ...
         <tbody>
<form action="deleteTingg5.php" method="POST">
<?php

$sQuery = "SELECT `ID`, `Nama`, `Tingkatan`, `Judul_Buku`, `Harga` FROM `jumlah_bukuting5`";
