...
<body>
<header>
<h1 class="Upper">Buku Tingkatan 3</h1>
...
{
$sql = "INSERT INTO `jumlah_bukuting3`(`ID`, `Nama`, `Tingkatan`, `Judul_Buku`, `Harga`) values ('$ID','$NamaBuku','$Kelas','$JudulB','$Harga')";
if ($con->query($sql)){
...
<th>Delete</th>
         ...
         <tbody>
<form action="deleteTingg3.php" method="POST">
<?php

$sQuery = "SELECT `ID`, `Nama`, `Tingkatan`, `Judul_Buku`, `Harga` FROM `jumlah_bukuting3`";
