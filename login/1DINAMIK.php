...
<?php
//mengunakan sistem yang sama seperti signup.php
//memulakan sesi
session_start();
...
{
$sql = "INSERT INTO 1dinamik (ID,Nama,Kelas) values ('$ID','$NamaBuku','$Kelas')";
if ($con->query($sql)){
...
<?php
//mengambil data daripada database  
$sQuery = "SELECT ID,Nama,Kelas from 1dinamik";
$result = $con->query($sQuery);
//code mempaparkan data ke table
...
//mengambil id BookModal
var modal = document.getElementById("BookModal");

//mengambil id Btn
var btn = document.getElementById("Btn");

//mengambil name close
