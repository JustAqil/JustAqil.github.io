...
if(isset($_POST['search']))
{
    ...
    $query = "SELECT * FROM `pemulangan` WHERE CONCAT (`ID`,`Nama`,`Kelas`,`Status`,`JudulBuku`) LIKE '%".$valueToSearch."%'";
    $search_result = filterTable($query);
    
}
 else {
    $query = "SELECT * FROM `pemulangan`";
    $search_result = filterTable($query);
}
...
{
header("Pemulangan.php");
  $sql = "INSERT INTO `pemulangan`(`ID`, `Nama`, `Kelas`, `Status`, `JudulBuku`) VALUES ('$ID','$NamaBuku','$Kelas','$JudB','$Stat')";
if ($con->query($sql)){
...
<form action ="Pemulangan.php" method="post">
