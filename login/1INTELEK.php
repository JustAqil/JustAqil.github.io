...
{
$sql = "INSERT INTO 1intelek (ID,Nama,Kelas) values ('$ID','$NamaBuku','$Kelas')";
if ($con->query($sql)){
...
<th>Delete</th>
         ...
         <tbody>
<form action="delete,1INTELEK.php" method="POST">
<?php

$sQuery = "SELECT ID,Nama,Kelas from 1intelek";
