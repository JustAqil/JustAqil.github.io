...
{
$sql = "INSERT INTO 3dinamik (ID,Nama,Kelas) values ('$ID','$NamaBuku','$Kelas')";
if ($con->query($sql)){
...
<th>Delete</th>
         ...
         <tbody>
<form action="delete_3d.php" method="POST">
<?php

$sQuery = "SELECT ID,Nama,Kelas from 3dinamik";
