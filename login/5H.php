...
{
$sql = "INSERT INTO 5h (ID,Nama,Kelas) values ('$ID','$NamaBuku','$Kelas')";
if ($con->query($sql)){
...
<th>Delete</th>
         ...
         <tbody>
<form action="Delete,5H.php" method="POST">
<?php

$sQuery = "SELECT ID,Nama,Kelas from 5h";
