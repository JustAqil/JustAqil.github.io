...
{
$sql = "INSERT INTO 4kreatif (ID,Nama,Kelas) values ('$ID','$NamaBuku','$Kelas')";
if ($con->query($sql)){
...
<th>Delete</th>
         ...
         <tbody>
<form action="delete4D.php" method="POST">
<?php

$sQuery = "SELECT ID,Nama,Kelas from 4kreatif";
