...
{
$sql = "INSERT INTO 5kreatif (ID,Nama,Kelas) values ('$ID','$NamaBuku','$Kelas')";
if ($con->query($sql)){
...
<th>Delete</th>
         ...
         <tbody>
<form action="Delete,5K.php" method="POST">
<?php

$sQuery = "SELECT ID,Nama,Kelas from 5kreatif";
